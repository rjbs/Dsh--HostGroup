...
=head2 groups_for_hosts
  ...
  my @groups = Dsh::Group::Groups->groups_for_hosts($host);

  my @groups = Dsh::Group::Groups->groups_for_hosts(\@hosts);
...
=head2 intersecting_groups_for_hosts
  ...
  my @groups = Dsh::Group::Groups->intersecting_groups_for_hosts($host);

  my @groups = Dsh::Group::Groups->intersecting_groups_for_hosts(\@hosts);
...
=head2 hosts_for_groups
  ...
  my @hosts = Dsh::Group::Groups->hosts_for_groups($group);

  my @hosts = Dsh::Group::Groups->hosts_for_groups(\@groups);
...
=head2 hosts_for_intersecting_groups
  ...
  my @hosts = Dsh::Group::Groups->hosts_for_intersecting_groups(\@groups);
...
=head2 locations_for_hosts
  ...
  my @locations = Dsh::Group::Groups->locations_for_hosts(\@hosts, \%arg);
...
=head2 all_groups
  ...
  my @groups = Dsh::Group::Groups->all_groups;
